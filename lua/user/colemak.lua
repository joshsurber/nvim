...
map("n", "j", "e", { remap = false })
map("n", "k", "nzzzv", { remap = false })
map("n", "l", "i", { remap = false })

map("n", "L", "I", { remap = false })
map("n", "K", "Nzzzv", { remap = false })
map("n", "E", "K", { remap = false })

map("n", "n", "gj", { remap = false })
map("v", "n", "j", { remap = false })
map("n", "e", "gk", { remap = false })
map("v", "e", "k", { remap = false })
map("n", "i", "l", { remap = false })
map("v", "i", "l", { remap = false })
map("v", "o", "l", { remap = false })
